...
/**
 * Created by Chentie on 2017/7/28.
 */
...
public class LinePathView extends View {
    ...
    /**
     * Do nothing when onSizeChanged callback 20180508
     */
    private boolean disableSizeChange = false;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (!disableSizeChange) {
            cachebBitmap = Bitmap.createBitmap(getWidth(), getHeight(), Bitmap.Config.ARGB_4444);
    ...
    public Bitmap save() throws IOException {
        Bitmap bitmap = cachebBitmap;
        Bitmap bm = Bitmap.createScaledBitmap(bitmap, 300, 450, true);
       // LogUtils.i("bitmap:" + bitmap.getByteCount() / 1024  +  "bm:" + bm.getByteCount() / 1024);
        return bm;
    }
    ...
    public boolean isDisableSizeChange() {
        return disableSizeChange;
    }

    public void setDisableSizeChange(boolean disableSizeChange) {
        this.disableSizeChange = disableSizeChange;
    }
